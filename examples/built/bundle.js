...
"GRID-WIN":{"prep":{"tgn":"WIN","as":"grid-win","attr":{"as":"grid-win","caption":"window with grid"},"ch":[{"tgn":"GRID:APP","attr":{"style":"height:100%;min-height: 150px;","_ref":"grid"},"ch":[]}],"script":function anonymous(appContext,factory,document,require
) {
...
"CELL":{"prep":{"tgn":"DIV","as":"cell","attr":{"as":"cell","usetag":"td","style":"text-align:center;width:10%;"},"ch":[],"script":function anonymous(appContext,factory,document,require
) {
...
"APP":{"prep":{"tgn":"DIV","as":"app","attr":{"as":"app"},"ch":[{"tgn":"BUTTON","attr":{"_ref":"button"},"ch":["open win"]},{"tgn":"BUTTON","attr":{"_ref":"button1"},"ch":["open modal win"]},{"tgn":"BUTTON","attr":{"_ref":"button2"},"ch":["open grid-win"]},{"tgn":"BUTTON","attr":{"_ref":"button3"},"ch":["open slider"]}],"script":function anonymous(appContext,factory,document,require
) {
...
"ROW":{"prep":{"tgn":"tr","as":"row","attr":{"as":"row","super":"array-iterator","tagname":"tr"},"ch":[{"tgn":"POPUPS:CELL","attr":{},"ch":[]},{"tgn":"POPUPS:CELL","attr":{"style":"background-color:rgba(128,128,128,0.3)"},"ch":[]}],"superc":"array-iterator","script":function anonymous(appContext,factory,document,require
) {
...
"XCELL":{"prep":{"tgn":"DIV","as":"xcell","attr":{"as":"xcell","usetag":"td","style":"text-align:center;width:10%;"},"ch":[],"script":function anonymous(appContext,factory,document,require
) {
...
"APP":{"prep":{"tgn":"DIV","as":"app","attr":{"as":"app"},"ch":[{"tgn":"TBL","attr":{"_ref":"table"},"ch":[]}],"script":function anonymous(appContext,factory,document,require
) {
...
return new W3View(appContext)
.setRegistry({"HELLO-WORLD":{"prep":{"tgn":"DIV","as":"hello-world","attr":{"as":"hello-world"},"ch":[{"tgn":"H1","attr":{"_ref":"content"},"ch":[]},{"tgn":"INPUT","attr":{"placeholder":"type your name here","_ref":"input"},"ch":[]},{"tgn":"H2","attr":{},"ch":["Hello ",{"tgn":"SPAN","attr":{"_ref":"name"},"ch":["Anonimous"]},"!"]}],"script":function anonymous(appContext,factory,document,require
) {
...
return new W3View(appContext)
.setRegistry({"SLIDER":{"prep":{"tgn":"DIV","as":"slider","attr":{"as":"slider","min":"0","max":"1","value":"0"},"ch":[{"tgn":"DIV","attr":{"style":"padding:20px;border:1px solid black;"},"ch":[{"tgn":"DIV","attr":{"style":"height:10px;border:1px solid black;","_ref":"bar"},"ch":[{"tgn":"DIV","attr":{"style":"position:relative;height:0px;width:0px","_ref":"mover"},"ch":[{"tgn":"DIV","attr":{"style":"position:absolute;margin:-10px 0 0 -10px;width:20px; height:30px;border:1px solid black;background-color:gray;"},"ch":[]}]}]}]}],"script":function anonymous(appContext,factory,document,require
) {
...
"COLOR-CHOOSER":{"prep":{"tgn":"DIV","as":"color-chooser","attr":{"as":"color-chooser","style":"box-sizing:border-box;"},"ch":[{"tgn":"H1","attr":{"col":"2","_ref":"content"},"ch":[]},{"tgn":"SLIDER","attr":{"min":"0","max":"255","value":"128","style":"background-color:white;","col":"8","_ref":"slider"},"ch":[]},{"tgn":"INPUT","attr":{"type":"text","col":"2","style":"text-align:right;height:50px;\n          font-size:40px;overflow:visible;border:0;\n          border-bottom:5px solid green;min-width:100px;padding:10px 10px;","_ref":"value"},"ch":[]},{"tgn":"CLEAR","attr":{},"ch":[]}],"script":function anonymous(appContext,factory,document,require
) {
...
"RGB-CHOOSER":{"prep":{"tgn":"DIV","as":"rgb-chooser","attr":{"as":"rgb-chooser","style":"border:1px solid black; padding:20px;"},"ch":[{"tgn":"COLOR-CHOOSER","attr":{"_ref":"red"},"ch":["Red"]},{"tgn":"COLOR-CHOOSER","attr":{"_ref":"green"},"ch":["Green"]},{"tgn":"COLOR-CHOOSER","attr":{"_ref":"blue"},"ch":["Blue"]}],"script":function anonymous(appContext,factory,document,require
) {
...
})(appContext),{"evaluated":(function(){var module={};function aa(){
...
factory[0].putModule('slider',factory[3], 'html');
factory[0].putModule('hello',factory[2], 'html');
factory[0].putModule('script',factory[4], 'js');
factory[1].putModule('popups',factory[0], 'html');
factory[1].putModule('hello',factory[2], 'html');
return factory[0];}
