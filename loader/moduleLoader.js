...
/**
   ...
   * 
   * @property loadModules - то-же, что и moduleLoader, но для сборщика, не нужен appContext и в onload передаёт загруженные модули
   */
const moduleLoader = (function () {
  ...
  moduleLoader.loadModules = function (src, reader, onload) {
    src = reader.makeSrc(src)
    loadModule(src, reader, (mod) => {
      const extracted = {}
      const extract = (src) => {
